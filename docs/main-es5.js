...
var DataTableSource = /** @class */ (function (_super) {
    ...
    function DataTableSource(DATA) {
         ...
         */
        function (_a) {
            var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__read"])(_a, 2), d = _b[0], filter = _b[1];
            return filter && typeof filter === 'string' && filter.trim().length > 0
                 ...
                 */
                function (dEl) {
                    return Object.keys(dEl || {})
                        .map((/**
                     * @param {?} key
                     * @return {?}
                     */
                    function (key) { return dEl[key]; }))
                        .filter((/**
                     * @param {?} dElement
                     * @return {?}
                     */
...
var SharedComponentsModule = /** @class */ (function () {
    ...
    SharedComponentsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            exports: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"]([_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], hammerhead_ui__WEBPACK_IMPORTED_MODULE_5__["HammerheadUiModule"]], COMPONENTS, MATERIAL_MODULES)
        })
...
var DataTableExampleBComponent = /** @class */ (function () {
    ...
    DataTableExampleBComponent.prototype.onRefresh = function () {
        var _this = this;
        this.isRefreshing = true;
        setTimeout(function () { return (_this.isRefreshing = false); }, 0);
    };
...
var DataTableExampleCComponent = /** @class */ (function () {
    function DataTableExampleCComponent(snackBar) {
        this.snackBar = snackBar;
        this.config = {
    ...
    DataTableExampleCComponent.prototype.onEdit = function (token) {
        this.snackBar.open("You want to edit token " + token.id + ".", undefined, { duration: 3000 });
    };
    DataTableExampleCComponent.prototype.onDelete = function (token) {
        this.snackBar.open("Are you sure you want to delete " + token.id + "?", 'DO IT', { duration: 3000 });
    };
    DataTableExampleCComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
    ...
    return DataTableExampleCComponent;
}());
...
var DataTableExampleDComponent = /** @class */ (function () {
    function DataTableExampleDComponent(snackBar) {
        var _this = this;
        this.snackBar = snackBar;
        this.config = {
            columns: [{ property: 'id', width: '112px' }, { property: 'token' }],
            ...
            rowActions: [
                { id: 'edit', isIcon: true, icon: 'edit', onClick: this.onEdit.bind(this) },
                {
                    ...
                    onClick: function (token) {
                        _this.snackBar.open("Are you sure you want to delete " + token.id + "?", 'DO IT', { duration: 3000 });
                    }
                }
            ],
    ...
    DataTableExampleDComponent.prototype.onEdit = function (token) {
        this.snackBar.open("You want to edit token " + token.id + ".", undefined, { duration: 3000 });
    };
    DataTableExampleDComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
    ...
    return DataTableExampleDComponent;
}());
...
var DataTableExampleEComponent = /** @class */ (function () {
    function DataTableExampleEComponent(snackBar) {
        var _this = this;
        this.snackBar = snackBar;
        this.config = {
            columns: [{ property: 'id', width: '112px' }, { property: 'token' }],
    ...
    DataTableExampleEComponent.prototype.onEdit = function (token) {
        this.snackBar.open("You want to edit token " + token.id + ".", undefined, { duration: 3000 });
    };
    DataTableExampleEComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
    ...
    return DataTableExampleEComponent;
}());
...
var DataTableExampleFComponent = /** @class */ (function () {
    function DataTableExampleFComponent(snackBar) {
        this.snackBar = snackBar;
        this.config = {
            columns: [{ property: 'id' }, { property: 'token' }],
            data: [],
    ...
    DataTableExampleFComponent.prototype.onEdit = function (token) {
        this.snackBar.open("You want to edit token " + token.id + ".", undefined, { duration: 3000 });
    };
    DataTableExampleFComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
    ...
    return DataTableExampleFComponent;
}());
